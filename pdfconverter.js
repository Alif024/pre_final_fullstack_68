...
const PDF_JOBS = [
  ...
  { inputDir: "backend", outputFile: "Backend_API_Server_And_Database.pdf", extensions: ["seed.js", "data.json", "load.js"] },
  { inputDir: "frontend", outputFile: "Frontend_Web_Server.pdf", extensions: ["app.js"] },
  { inputDir: "frontend/views", outputFile: "Frontend_EJS_Templates.pdf", extensions: [".ejs"] },
  { inputDir: "frontend/public", outputFile: "Frontend_CSS_Styles.pdf", extensions: [".css"] },
  { inputDir: "backend/database", outputFile: "Backend_Database_Seed.pdf", extensions: [".js"] },
];
